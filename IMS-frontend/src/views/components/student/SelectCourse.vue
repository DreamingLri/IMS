<script setup>
import {ArrowRight, CircleCheck, CircleClose, Delete, Edit, Plus, Refresh, Search} from "@element-plus/icons-vue";
...
function getSelectedCourse(){
  request.get("/course/listCourseById?id="+user.id).then(res =>{
    if(res.code === 200){
