          ...
          <el-scrollbar class="el-scrollbar">
            ...
            >
              ...
              <el-sub-menu index="1">
                ...
                <el-menu-item-group>
                  <el-menu-item index="1-1" @click="router.push('/admin/student-info')">学生信息</el-menu-item>
                  <el-menu-item index="1-2" @click="router.push('/admin/select-course')">学生选课</el-menu-item>
                  <el-menu-item index="1-3" @click="router.push('/admin/student-score')">学生成绩</el-menu-item>
                  <el-menu-item index="1-4" @click="router.push('/admin/class-table')">学生课表</el-menu-item>
                </el-menu-item-group>
              </el-sub-menu>
              <el-sub-menu index="2">
                <template #title>
              ...
              <el-sub-menu index="3">
                ...
                <el-menu-item-group>
                  <el-menu-item index="3-1" @click="router.push('/admin/exam')">考试信息</el-menu-item>
                  <el-menu-item index="3-2" @click="router.push('/admin/exam-student')">考试学生</el-menu-item>
                </el-menu-item-group>
              </el-sub-menu>
              <el-sub-menu index="4">
                <template #title>
                ...
                <el-menu-item-group>
                  <el-menu-item index="4-1" @click="router.push('/admin/course')">课程信息</el-menu-item>
                  <el-menu-item index="4-2" @click="router.push('/admin/course-time')">课程时间</el-menu-item>
                  <el-menu-item index="4-3" @click="router.push('/admin/course-status')">选课情况</el-menu-item>
                </el-menu-item-group>
              </el-sub-menu>
            </el-menu>
          </el-scrollbar>
